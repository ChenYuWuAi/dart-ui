...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->scrHome_del = true;
    ui->scrVision_del = true;
    ui->scrParamsEdit_del = true;
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_scrStatistic(ui);
    lv_screen_load(ui->scrStatistic);
}
...
void init_keyboard(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_fusionpixellatin_18, LV_PART_MAIN|LV_STATE_DEFAULT);
}
